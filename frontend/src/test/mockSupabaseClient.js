...
// signInWithOtp / verifyOtp / signOut / signInWithOAuth / updateUser /
// resetPasswordForEmail). Pass `overrides` to replace/extend individual
// methods per test, e.g.:
...
export function createMockSupabaseClient(overrides = {}) {
  return {
    auth: {
      ...
      verifyOtp: vi.fn().mockResolvedValue({ data: { session: { user: { id: 'user-1' }, access_token: 'tok-1' }, user: { id: 'user-1' } }, error: null }),
